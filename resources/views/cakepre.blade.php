...
<div
    ...
    <!-- Page Header Start -->
    <div
      class="container-fluid page-header-cakepre py-6 wow fadeIn"
      data-wow-delay="0.1s"
    >
      <div class="container text-center pt-5 pb-3">
        <h1 class="display-4 text-white animated slideInDown mb-3">Cakes</h1>
    ...
    <div class="container-xxl py-6">
      <div class="container">
        ...
        >
          ...
          <h1 class="display-6 mb-4">Cake preparation courses for you</h1>
        </div>
        <div class="row g-4">
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="team-item text-center rounded overflow-hidden">
              <img class="img-fluid" src="{{ asset('img/cup cakes.jpg')}}" alt="" />
              <div class="team-text">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="team-item text-center rounded overflow-hidden">
              <img class="img-fluid" src="{{ asset('img/Sponge CAkes.jpg')}}" alt="" />
              <div class="team-text">
                <div class="team-title">
                  <h5>Pound Cake</h5>
                  <span></span>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="team-item text-center rounded overflow-hidden">
              <img class="img-fluid" src="{{ asset('img/creamCakes.jpg')}}" alt="" />
              <div class="team-text">
                <div class="team-title">
                  <h5>cream cakes</h5>
                  <span></span>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
            <div class="team-item text-center rounded overflow-hidden">
              <img class="img-fluid" src="{{ asset('img/Occasional.jpg')}}" alt="" />
              <div class="team-text">
                <div class="team-title">
                  <h5>occasional</h5>
                  <span></span>
