...
<div
    ...
    <!-- Page Header Start -->
    <div
      class="container-fluid page-header-cookiepre py-6 wow fadeIn"
      data-wow-delay="0.1s"
    >
      <div class="container text-center pt-5 pb-3">
        <h1 class="display-4 text-white animated slideInDown mb-3">Cookies</h1>
    ...
    <div class="container-xxl py-6">
      <div class="container">
        ...
        >
          ...
          <h1 class="display-6 mb-4">Cookies preparation courses for you</h1>
        </div>
        <div class="row g-4">
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="team-item text-center rounded overflow-hidden">
              <img class="img-fluid" src="{{ asset('img//Normal.jpg')}}" alt="" />
              <div class="team-text">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="team-item text-center rounded overflow-hidden">
              <img class="img-fluid" src="{{ asset('img/nutcookie.jpg')}}" style="height: 326px" alt=""  />
              <div class="team-text">
                <div class="team-title">
                  <h5>Nut flavoured</h5>
                  <span></span>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="team-item text-center rounded overflow-hidden">
              <img class="img-fluid" src="{{ asset('img/CoffeeCookie.jpg')}}" alt="" />
              <div class="team-text">
                <div class="team-title">
                  <h5>Coffee flavoured</h5>
                  <span></span>
                </div>
                <div class="team-social">
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
            <div class="team-item text-center rounded overflow-hidden">
              <img class="img-fluid" src="{{ asset('img/occasionalCookie.jpg')}}" style="height: 326px" alt="" />
              <div class="team-text">
                <div class="team-title">
                  <h5>Occasional cookie</h5>
                  <span></span>
                </div>
                <div class="team-social">
